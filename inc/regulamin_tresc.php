				<ol type='1'>
						...
						<li>Poniższe typy stron nie są wspierane i nie będą tolerowane przez System GoodStat:
							<ol type='a'>
								...
								<li>strony zawierające informacje, materiały lub dyskusje prowadzone w nielegalnej działalności</li>
								<li>strony promujące lub wykorzystujące oprogramowanie zaprojektowany do dostarczania niechcianej korespondencji email</li>
								<li>strony zawierające dziecięcą pornografię, albo jakiekolwiek inne, które ogólnie uznawane są za niestosowne</li>								
							</ol>
						</li>
						...
						<li>Autor nie odpowiada za jakiekolwiek straty wynikłe z używania Systemu GoodStat, w tym utratę spodziewanych korzyści, danych, informacji gospodarczych lub koszt urządzeń lub programów zastępczych.</li>
						<li>Nabywca bierze na siebie ryzyko wynikające z użytkowania Systemu GoodStat.</li>
						<li>Autor nie udziela żadnej gwarancji oraz rękojmi, że System GoodStat będzie działać na wszystkich serwerach.</li>
					
						<div class="page-header">
							<h2>Ochrona danych osobowych</h2>
						</div>

						<li>Wszelkie wprowadzone dane nabywcy podczas instalacji Systemu GoodStat, nigdzie nie są i nigdy nie będą przechowywane przez autora Systemu GoodStat, są one zbierane jedynie w celu prawidłowej instalacji Systemu GoodStat.</li>
