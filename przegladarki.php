...
function wskaznik($strona, $liczba_stron)
{
    ...
    if ($strona > 1) {
		$wynik .= " <li class='page-item'><a class='page-link' href='przegladarki.php?strona=1'><i class='material-icons'>first_page</i></a></li> ";
    } else {
    ...
    $poprzednia = $strona - 1;
    if ($poprzednia > 0) {
        $wynik .= " <li class='page-item'><a class='page-link' href='przegladarki.php?strona=$poprzednia'><i class='material-icons'>navigate_before</i></a></li> ";
    } else {
    ...
    if ($nastepna <= $liczba_stron) {
        $wynik .= " <li class='page-item'><a class='page-link' href='przegladarki.php?strona=$nastepna'><i class='material-icons'>navigate_next</i></a></li> ";
    } else {
    ...
    if ($strona < $liczba_stron) {
        $wynik .= " <li class='page-item'><a class='page-link' href='przegladarki.php?strona=$liczba_stron'><i class='material-icons'>last_page</i></a></li> ";
    } else {
...
?>
		<div class="page-header">
			<h1>Przeglądarki <span></span></h1>
		</div>
		
<?php
	$tab_danych = array(); //zainicjowanie tablicy bez wartosci
	szukaj_danych4('przegladarki', 'wejscia', "przegladarki");
?>
...
//STRONNICOWANIE
	...
	$stmt = $db->query("SELECT * FROM przegladarki");
	...
	<div class="table-responsive">
		...
		<tr>
			<th>przeglądarka</th> <th>wizyty</th> <th>wykres</th> <th>usuń</th>
		</tr>';

		szukaj_naj_godziny('przegladarki');
		
		$stmt = $db->query("SELECT * FROM `przegladarki` ORDER BY `przegladarki`.`wejscia` DESC LIMIT $start ,$rekordow_na_stronie");
						...
						<div class="modal-dialog modal-lg">
							<div class="modal-content">
								...
								<div class="modal-body">
									...
									<form action="przegladarki.php" method="post" class="form-horizontal">
										<ul class="list-group">								
											<li class="list-group-item">
												<div class="row">
													<div class="col-md-3">nazwa</div>						
													<div class="col-md-9"><b>'.$przegladarki.'</b></div>						
												</div>
											</li>									
										</ul>
								</div>
								...
								<div class="modal-footer">
										...
										<input type="hidden" value="'.$przegladarki.'" name="przegladarki">
